...
def power_iteration(operator, steps=100, error_threshold=1e-4,
                    momentum=0.0, use_gpu=True,
                    init_vec=None, eigen_index=None):
    """
    ...
    print("error tolerance exceeded on eigenvector " + str(eigen_index) + ", error was: " + str(error))
